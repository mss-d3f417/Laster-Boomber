#Hi Kidi pls Don't Copy My Code
...
$$ |     $$  __$$ | \____$$\   $$ |$$\ $$   ____|$$ |      
$$$$$$$$\\$$$$$$$ |$$$$$$$  |  \$$$$  |\$$$$$$$\ $$ |      
\________|\_______|\_______/    \____/  \_______|\__|  
                       ...
                       (__ (_   (_ . _) _) ,__)
                           ...
                           ,::: ;   ; :::,
                          ':::::::::::::::'
     _________________laster______/_ __ \________________________
    |                                                         |
    |  This Boomber Created By Laster & Updated by D3F417 :-) |
    |_________________________________________________________|
 _________________________
/\                        /
\_| Thank you for         |
  | using Laster Boomber! |
  |  _____________________|_
  \_/______________________/

''')
    while True:
        phone = is_phone(input(f'{g}[+] SHOMARE TARGET RA VARED KONID(Bedone +98 ex:0912000000) {r}- {w}'))
        if phone:
            break
    try:
